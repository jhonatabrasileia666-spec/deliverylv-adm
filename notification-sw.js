const CACHE_NAME='deliverylv-panel-v8-edge-manager';
const APP_SHELL=['./','./index.html','./lv-updates.js?v=20260925-edge-manager-v1','./manifest.webmanifest','./pwa-icon-192.svg','./pwa-icon-512.svg'];
